...
execute if score @s zyy.eet.settings.foucus matches -1 run scoreboard players set @s zyy.eet.settings.foucus 4
execute if score @s zyy.eet.settings.foucus matches 1 run scoreboard players set @s zyy.eet.settings.foucus 6
scoreboard players operation @s zyy.eet.settings.foucus -= 5 zyy.eet.num
